...
import { firstChapter } from "@/content/chapter";
...
export const defaultBookPage: BookPageContent = {
  ...
  chapter: {
    eyebrow: "במתנה",
    title: "הסיפורים הפותחים, לקריאה כאן",
    lead: "שני הסיפורים שפותחים את הספר, במלואם. בלי טופס, בלי הרשמה ובלי להוריד כלום.",
    body: md(firstChapter),

    closer: "כאן נעצר הפרק הראשון. ההמשך בספר המלא.",
  ...
  purchase: {
    ...
    formats: [
      ...
      "המחיר כולל מע״מ",
      "תשלום מאובטח בעמוד חיצוני",
      "להקדשה אישית או להזמנה של כמה עותקים — כותבים לי ונסדר",
    ],
    buyLabel: "לרכישת הספר",
    buyHref: "https://pay.grow.link/2ba2bb0496d2609afcdac8c62a3974a4-MjY0MjA3OA",
    note: "התשלום מתבצע בעמוד מאובטח של Grow, שנפתח בחלון חדש.",
  },
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "קראתי בנשימה אחת ו… חבל שנגמר. בכל סיפור ניכר הדמיון הפורה, היצירתיות וכושר הכתיבה המרתק. מצפה בכיליון עיניים להמשך.",
        name: "מירון",
      },
      {
        quote:
          "החיבור לכתיבה שלה הוא מיידי — כבר מהעמודים הראשונים הרגשתי שאני נשאב פנימה. הקריאה קולחת ומהנה מאוד, אבל מה שהופך את הספר הזה למיוחד בעיניי הוא העומק של הסיפורים: סיפורים מעוררי מחשבה שמרגישים רלוונטיים גם אחרי שמניחים את הספר.",
        name: "ערן",
      },
      {
        quote:
          "ספר מרגש מאוד, נוגע במקומות רגישים עם הומור ועם יכולת להתחבר לדמויות. מאוד מאוד אהבתי ואמליץ עליו. ספר לקריאה גם בין לבין, כי הוא קובץ סיפורים.",
        name: "אלי",
      },
    ],
  },
