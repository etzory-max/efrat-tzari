  ...
  return (
    <div className="bg-cream-50 pt-12 pb-20 md:pb-28">
      <div className="shell max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-ink [&_a]:underline [&_a]:underline-offset-4 [&_h2]:text-2xl [&_h2]:text-slate [&_li]:leading-relaxed [&_p]:leading-relaxed [&_ul]:space-y-2 [&_ul]:ps-5 [&_ul]:list-disc">
          {children}
        </div>
      </div>
    </div>
