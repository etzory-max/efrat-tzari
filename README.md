...
| תנועה | סטטי | הופעה הדרגתית ועדינה של האלמנטים תוך כדי גלילה |

### על ההופעה ההדרגתית

האלמנטים עולים ומתבהרים כשהם נכנסים לתצוגה, במדורג מלמעלה למטה. הכלל שמסתיר אותם
תלוי ב-`<html data-reveal="on">`, שנקבע ע"י סקריפט inline לפני הציור הראשון —
כלומר **בלי JavaScript, ב-`prefers-reduced-motion`, או כשמפעילים "עצירת אנימציות"
בתפריט הנגישות, שום דבר לא מוסתר מלכתחילה**. אפשרות שתוכן ייתקע בלתי-נראה לא קיימת.
`scripts/reveal-test.mjs` בודק את ארבעת המצבים האלה.
